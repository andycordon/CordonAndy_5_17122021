...
//Si le produit est supprimer, il disparait de la page panier et du local storage
					if (indexCartPage !== -1) {
						...
						cartItem[i].remove()
//Si le tableau crée précédement pour l'ajout des produits est vide, il est supprimer
						if (productInLocalStorage == '') {
							localStorage.removeItem('product')
							products = '';
						};
//Rechargment de la page si le panier est vide, pour indiquer que celui-ci l'est
            location.reload();
					};
          total();
